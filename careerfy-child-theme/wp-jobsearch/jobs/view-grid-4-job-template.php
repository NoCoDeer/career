                        ...
                        <div class="careerfy-jobs-box1">
                            ...
                            <div class="careerfy-jobs-style9-titlewrp">
                                <a class="careerfy-jobs-style9-title <?php echo($quick_apply_job_btn) ?>"
                                   ...
                                   href="<?php echo $quick_apply_job == 'on' && !wp_is_mobile() ? 'javascript:void(0)' : esc_url(get_permalink($job_id)); ?>"><?php echo esc_html(jobsearch__listing_itm_title_limit(get_the_title($job_id), $jobsearch_jobs_title_limit)); ?></a>
                                <?php
                    ...
                    <div class="careerfy-jobs-wrapper-style9<?php echo apply_filters('jobsearch_jobs_list_mainwrap_classes', '', $job_id, 'grid4') ?>">
                        <div class="careerfy-jobs-box1">
                            ...
                            <?php if ($job_city_title) { ?>
                                <span class="careerfy-jobs-style9-loc"><i
                                            class="jobsearch-icon jobsearch-maps-and-flags"></i> <?php echo($job_city_title) ?></span>
                            <?php }
                            ob_start();
                            ?>
                            <small class="careerfy-jobs-style9-options">
