        ...
        if ($employer_loop_obj->have_posts()) {
                        ...
                        <div class="jobsearch-table-row">
                            ...
                            <div class="jobsearch-table-cell">
                                ...
                                if ($jobsearch_employer_team_count > 0 && (is_array($team_imagefield_list) && sizeof($team_imagefield_list) > 0)) {
                                    ...
                                    <a href="<?php echo esc_url(get_permalink($employer_id)); ?>" class="jobsearch-employer-thumblist-size"><?php echo jobsearch_esc_html($jobsearch_employer_team_count); ?><?php echo esc_html__('team size', 'careerfy'); ?></a>
                                <?php } else { ?>
                                    &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                    <?php
                                }
                            ...
                            $follow_btn_args = array(
                                ...
                                'before_label' => esc_html__('Follow', 'careerfy'),
                                'after_label' => esc_html__('Followed', 'careerfy'),
                                'view' => 'list_view1',
                            );
            ...
            <li class="' . esc_html($columns_class) . '">
                <div class="no-employer-match-error">
                    ...
                    <a href="' . esc_url($page_url) . '">' . esc_html__('Reset Filters', 'careerfy') . '</a>
                </div>
            </li>';
        }
        ?>
